...
export default function ProductList() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Toolbar */}
      <div className="bg-slate-200 border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative min-w-[200px]">
          ...
          <select 
            ...
            className="w-full bg-slate-950 border border-slate-200 rounded-lg pl-10 pr-4 py-2 text-slate-200 focus:outline-none focus:border-brand appearance-none"
          >
            ...
            <tbody className="divide-y divide-slate-800/50">
              {loading ? (
                ...
                products.map(product => {
                  ...
                  return (
                    <tr key={product.id} className="hover:bg-slate-100/20 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-lg bg-slate-950 border border-slate-200 overflow-hidden flex items-center justify-center flex-shrink-0">
                            {thumbUrl ? (
          ...
          <div className="border-t border-slate-200 p-4 flex items-center justify-between text-sm text-slate-600">
            ...
            <div className="flex gap-2">
              <button 
                ...
                disabled={page === 1}
                className="p-2 rounded-lg border border-slate-200 hover:bg-slate-100 disabled:opacity-50 disabled:hover:bg-transparent transition-colors"
              >
                <ChevronLeft size={18} />
              </button>
              <button 
