    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1,2,3,4].map(i => (
            <div key={i} className="h-32 bg-slate-50 rounded-xl border border-slate-200 animate-pulse"></div>
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Out of stock */}
        <div className="bg-slate-50 p-6 rounded-xl border border-red-900/50 flex flex-col gap-4 relative overflow-hidden">
        ...
        {/* Missing Images */}
        <div className="bg-slate-50 p-6 rounded-xl border border-amber-900/50 flex flex-col gap-4 relative overflow-hidden">
          <div className="flex items-center justify-between z-10">
        ...
        <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 flex flex-col gap-4 relative overflow-hidden">
          <div className="flex items-center justify-between z-10">
            ...
            <div className="p-2 bg-white text-slate-800 rounded-lg">
              <Layers size={20} />
            </div>
          </div>
          <div className="z-10">
