    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1,2,3,4].map(i => (
            <div key={i} className="h-32 bg-slate-900 rounded-xl border border-slate-800 animate-pulse"></div>
          ))}
        </div>
      </div>
    );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <h3 className="text-slate-400 font-medium">Total de Produtos</h3>
        ...
        {/* Out of stock */}
        <div className="bg-slate-900 p-6 rounded-xl border border-red-900/50 flex flex-col gap-4 relative overflow-hidden">
          <div className="flex items-center justify-between z-10">
            <h3 className="text-slate-400 font-medium">Em Falta</h3>
          ...
          <div className="z-10">
            ...
            <div className="text-sm text-slate-500 mt-1">Requerem atenção</div>
          </div>
        ...
        {/* Missing Images */}
        <div className="bg-slate-900 p-6 rounded-xl border border-amber-900/50 flex flex-col gap-4 relative overflow-hidden">
          <div className="flex items-center justify-between z-10">
            <h3 className="text-slate-400 font-medium">Sem Imagem</h3>
          ...
          <div className="z-10">
            ...
            <div className="text-sm text-slate-500 mt-1">Incompletos na vitrine</div>
          </div>
        ...
        <div className="bg-slate-900 p-6 rounded-xl border border-amber-900/50 flex flex-col gap-4 relative overflow-hidden">
          <div className="flex items-center justify-between z-10">
            <h3 className="text-slate-400 font-medium">Ficha Técnica Vazia</h3>
            <div className="p-2 bg-amber-500/10 text-amber-400 rounded-lg">
              <FileText size={20} />
            </div>
          </div>
          <div className="z-10">
            ...
            <div className="text-sm text-slate-500 mt-1">Faltam especificações</div>
          </div>
        ...
        {/* Empty Categories */}
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 flex flex-col gap-4 relative overflow-hidden">
          <div className="flex items-center justify-between z-10">
            <h3 className="text-slate-400 font-medium">Categorias Vazias</h3>
          ...
          <div className="z-10">
            ...
            <div className="text-sm text-slate-500 mt-1">Sem produtos atrelados</div>
          </div>
        </div>
