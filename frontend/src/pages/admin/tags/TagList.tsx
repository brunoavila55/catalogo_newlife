  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 mb-8">
        <h3 className="text-lg font-medium text-slate-300 mb-4">Nova Tag</h3>
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-800/50">
            {loading ? (
              ...
              <tr>
                <td colSpan={2} className="px-6 py-8 text-center text-slate-500">Nenhuma tag encontrada.</td>
              </tr>
            ) : (
              tags.map(tag => (
                <tr key={tag.id} className="hover:bg-slate-800/20 transition-colors">
